 ...
 * 
 */
package com.gary.ros.rosbridge.operation;
...
import com.gary.ros.rosbridge.implementation.JSON;
import com.gary.ros.rosbridge.implementation.Registry;
...
public class Operation extends Message {
    ...
    public static void initialize(Registry<Class> registry) {
        ...
        initClass(registry, CompressedImage.class);
        initClass(registry, Time.class);
