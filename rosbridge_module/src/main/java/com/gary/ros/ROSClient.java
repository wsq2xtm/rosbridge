...
public abstract class ROSClient {
    ...
    public abstract boolean connect(ConnectionStatusListener listener,MessageCallback messageCallback);
    ...
    public interface MessageCallback{
        void  messageCallback(Operation operation, String topicOrServiceName, String content);
    }
}
